...
<div id='buttons' className='py-2' >
 ...
 <button className="relative w-11/12 h-1/4 bg-slate-950 hover:bg-slate-800 transform hover:scale-105 transition-all duration-80 mx-auto my-auto rounded-lg">
    <div className="px-3 py-3 flex justify-center items-center h-full">
      ...
      <span className="ml-2 text-white text-xl font-semibold">Dispach</span>
    </div>
</button>
